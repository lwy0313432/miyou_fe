  ...
  <el-header>
      <el-col :span="24" >
            <el-col :span="12" style="font-size:26px;">
                <img src="https://caiyunupload.b0.upaiyun.com/newweb/imgs/logo.png" class="logo"><span style="padding-left:20px;color:#fff">银豆个贷平台<i style="color:#20a0ff"></i></span>
            </el-col>
            ...
            <section >
                <el-col :span="24" style="margin-bottom:15px;">
                    ...
                    <el-breadcrumb separator="/" style="float:right;">
                        <el-breadcrumb-item :key="index" v-for="(item,index) in getRightNavLinks" :to="{ path: item.link }">
                            {{item.title}}
                        </el-breadcrumb-item>
                    </el-breadcrumb>
                </el-col>
  ...
  methods: {
    ...
    updatepwd_submit(formName) {
      this.$refs[formName].validate((valid) => {
          if (valid) {
              api.usercenter_change_my_passwd({
